...
namespace Administración {
    ...
    public partial class DsBancos : global::System.Data.DataSet {
        ...
        public partial class BancosDataTable : global::System.Data.TypedTableBase<BancosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BancosRow AddBancosRow(string Nombre) {
...
namespace Administración.DsBancosTableAdapters {
    ...
    public partial class BancosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Bancos] WHERE (([idBanco] = @Original_idBanco) AND ([Nombre] = @Orig" +
                "inal_Nombre))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Bancos] ([Nombre]) VALUES (@Nombre);\r\nSELECT idBanco, Nombre FROM Ba" +
                "ncos WHERE (idBanco = SCOPE_IDENTITY()) ORDER BY Nombre";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Bancos] SET [Nombre] = @Nombre WHERE (([idBanco] = @Original_idBanco) AND" +
                " ([Nombre] = @Original_Nombre));\r\nSELECT idBanco, Nombre FROM Bancos WHERE (idBa" +
                "nco = @idBanco) ORDER BY Nombre";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT     idBanco, Nombre\r\nFROM         Bancos\r\nORDER BY Nombre";
        ...
        public virtual int Fill(DsBancos.BancosDataTable dataTable) {
        ...
        public virtual DsBancos.BancosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DsBancos.BancosDataTable dataTable = new DsBancos.BancosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DsBancos.BancosDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DsBancos dataSet) {
        ...
        public virtual int Delete(int Original_idBanco, string Original_Nombre) {
        ...
        public virtual int Update(string Nombre, int Original_idBanco, string Original_Nombre, int idBanco) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Original_idBanco));
            if ((Original_Nombre == null)) {
                throw new global::System.ArgumentNullException("Original_Nombre");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(idBanco));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, int Original_idBanco, string Original_Nombre) {
            return this.Update(Nombre, Original_idBanco, Original_Nombre, Original_idBanco);
        }
    }
}
