...
namespace Administración {
    ...
    public partial class DsUsuarios : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Usuario, bool Activo, string Iniciales, string Apellido, string Nombre, int idEmpleado, bool Director) {
        ...
        public partial class UsuariosRow : global::System.Data.DataRow {
            ...
            public string Iniciales {
                get {
                    try {
                        return ((string)(this[this.tableUsuarios.InicialesColumn]));
                    }
                ...
                set {
                    this[this.tableUsuarios.InicialesColumn] = value;
                }
            }
            ...
            public bool Director {
                get {
                    try {
                        return ((bool)(this[this.tableUsuarios.DirectorColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Director\' in table \'Usuarios\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableUsuarios.DirectorColumn] = value;
                }
            }
            ...
            public bool IsInicialesNull() {
                return this.IsNull(this.tableUsuarios.InicialesColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetInicialesNull() {
                this[this.tableUsuarios.InicialesColumn] = global::System.Convert.DBNull;
            }
            ...
            public bool IsDirectorNull() {
                return this.IsNull(this.tableUsuarios.DirectorColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetDirectorNull() {
                this[this.tableUsuarios.DirectorColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Administración.DsUsuariosTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Usuarios] WHERE (([idUsuario] = @Original_idUsuario) AND ([Usuario] = @Original_Usuario) AND ([Activo] = @Original_Activo) AND ((@IsNull_Iniciales = 1 AND [Iniciales] IS NULL) OR ([Iniciales] = @Original_Iniciales)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_idEmpleado = 1 AND [idEmpleado] IS NULL) OR ([idEmpleado] = @Original_idEmpleado)) AND ((@IsNull_Director = 1 AND [Director] IS NULL) OR ([Director] = @Original_Director)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Usuarios] SET [Usuario] = @Usuario, [Activo] = @Activo, [Iniciales] = @Iniciales, [Apellido] = @Apellido, [Nombre] = @Nombre, [idEmpleado] = @idEmpleado, [Director] = @Director WHERE (([idUsuario] = @Original_idUsuario) AND ([Usuario] = @Original_Usuario) AND ([Activo] = @Original_Activo) AND ((@IsNull_Iniciales = 1 AND [Iniciales] IS NULL) OR ([Iniciales] = @Original_Iniciales)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_idEmpleado = 1 AND [idEmpleado] IS NULL) OR ([idEmpleado] = @Original_idEmpleado)) AND ((@IsNull_Director = 1 AND [Director] IS NULL) OR ([Director] = @Original_Director)));
SELECT idUsuario, Usuario, Activo, Iniciales, Apellido, Nombre, idEmpleado, Director FROM Usuarios WHERE (idUsuario = @idUsuario) ORDER BY Usuario";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT     idUsuario, Usuario, Activo, Iniciales, Apellido, Nombre, idEmpleado, D" +
                "irector\r\nFROM         Usuarios\r\nORDER BY Usuario";
        ...
        public virtual int Delete(int Original_idUsuario, string Original_Usuario, bool Original_Activo, string Original_Iniciales, string Original_Apellido, string Original_Nombre, global::System.Nullable<int> Original_idEmpleado, global::System.Nullable<bool> Original_Director) {
            ...
            if ((Original_Iniciales == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_Iniciales));
            }
            ...
            if ((Original_Director.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((bool)(Original_Director.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((Director.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((bool)(Director.Value));
            }
            else {
            ...
            if ((Original_Director.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((bool)(Original_Director.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Usuario, bool Activo, string Iniciales, string Apellido, string Nombre, global::System.Nullable<int> idEmpleado, global::System.Nullable<bool> Director, int Original_idUsuario, string Original_Usuario, bool Original_Activo, string Original_Iniciales, string Original_Apellido, string Original_Nombre, global::System.Nullable<int> Original_idEmpleado, global::System.Nullable<bool> Original_Director) {
            return this.Update(Usuario, Activo, Iniciales, Apellido, Nombre, idEmpleado, Director, Original_idUsuario, Original_Usuario, Original_Activo, Original_Iniciales, Original_Apellido, Original_Nombre, Original_idEmpleado, Original_Director, Original_idUsuario);
        }
    }
}
