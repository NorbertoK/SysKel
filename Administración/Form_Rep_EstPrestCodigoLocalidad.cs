...
{
    public partial class FormRepEstPrestCodigoLocalidad : FormCR
    {
        ...
        public FormRepEstPrestCodigoLocalidad()
        {
            InitializeComponent();
        }
        ...
        {
            _crParameterFieldDefinitions = crEstPrestCodigoLocalidad1.DataDefinition.ParameterFields;
            ...
            crEstPrestCodigoLocalidad1.SetDataSource(dsRepPrestCodigoLocalidad1);
