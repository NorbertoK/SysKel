...
/****** Object:  View [dbo].[View_Hist_RenglonesFacturaProforma]    Script Date: 03/13/2014 16:25:50 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[View_Hist_RenglonesFacturaProforma]
AS
SELECT     idHist_RenglonesFacturaProforma, dbo.NombreCompletoDelCliente
                          ((SELECT     idCliente
                              FROM         dbo.Contratos
                              WHERE     (idContrato = h.idContrato_anterior))) AS Cliente, idRenglonFacturaProforma,
                          (SELECT     Nombre
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_Hist_RenglonesFacturaProforma'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_Hist_RenglonesFacturaProforma'
GO
