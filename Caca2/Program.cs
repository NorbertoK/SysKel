...
namespace Caca2
{
 ...
 //               certificado = "..\\..\\kelijman.crt"; //certificado de prueba;
 //               claveprivada = "..\\..\\kelijman.key"; // " clave privada de prueba;

                certificado = "C:\\PyAfipWs\\SAE.crt"; //certificado de prueba;
                claveprivada = "C:\\PyAfipWs\\SAE.key"; // " clave privada de prueba;
            ...
            try
            {
                ...
                WSFEv1.Cuit = "20167784233";

                // Conectar al Servicio Web de Facturación
                proxy = ""; // "usuario:clave@localhost:8000"
                wsdl = "https://wswhomo.afip.gov.ar/wsfev1/service.asmx?WSDL";
                cache = "";//Path
                const string wrapper = "pycurl";
                ok = WSFEv1.Conectar(cache, wsdl, proxy, wrapper); // homologación
