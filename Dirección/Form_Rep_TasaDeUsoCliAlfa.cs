...
namespace Dirección
{
    public partial class FormRepTasaDeUsoCliAlfa : FormCR
    {
        public FormRepTasaDeUsoCliAlfa()
        {
            InitializeComponent();
        }
        ...
        {
            _crParameterFieldDefinitions = CR_TasaDeUsoCliAlfa1.DataDefinition.ParameterFields;
            CR_TasaDeUsoCliAlfa1.SetDataSource(DsRepTasaDeUso1);
