...
namespace Dirección
{
    public partial class FormRepTasaDeUsoRubroCliAlfa : FormCR
    {
        public FormRepTasaDeUsoRubroCliAlfa()
        {
            InitializeComponent();
        }
        ...
        {
            _crParameterFieldDefinitions = CR_TasaDeUso1.DataDefinition.ParameterFields;
            CR_TasaDeUso1.SetDataSource(DsRepTasaDeUso1);
