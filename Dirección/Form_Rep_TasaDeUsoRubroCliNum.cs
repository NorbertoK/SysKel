...
namespace Dirección
{
    public partial class FormRepTasaDeUsoRubroCliNum : FormCR
    {
        public FormRepTasaDeUsoRubroCliNum()
        {
            InitializeComponent();
        }
        ...
        {
            _crParameterFieldDefinitions = CR_TasaDeUsoRubroNum1.DataDefinition.ParameterFields;
            CR_TasaDeUsoRubroNum1.SetDataSource(DsRepTasaDeUso1);
