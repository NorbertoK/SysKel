namespace Dirección
{
    partial class FormRepEstPrestMedicamentosUtilizados
    {
        ...
        {
            this.crEstPrestMedicamentosUtilizados1 = new Dirección.CR_EstPrest_MedicamentosUtilizados();
            this.dsRepPrestMedicamentosUtilizados1 = new Dirección.WS.DsRepPrestMedicamentosUtilizados();
